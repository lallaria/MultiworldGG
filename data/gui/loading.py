...
class LoadingAnimation(MDRelativeLayout):
    frames = ListProperty([])
    img_box: MDBoxLayout
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.app = App.get_running_app()#.ctx.ui
        ...
        img = PILImage.open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "data", "loading_animation.png"))
    ...
    def show_loading(self):
        if not self.loading and not self.img_box.parent:
            ...
            self._clock_event = Clock.schedule_interval(self.update_frame, self.DEFAULT_SPEED)
