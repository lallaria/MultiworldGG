...
if not status then
    print("ERROR: Missing required Lua dependencies, this Lua script must be placed in the data/lua folder of your MultiworldGG installation.")
    return
end
...
function main()
    ...
    print("Diddy Kong Racing MultiworldGG Version: " .. APWORLD_VERSION)
    print("----------------")
