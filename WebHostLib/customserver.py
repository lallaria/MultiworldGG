...
class WebHostContext(Context):
    ...
    def load(self, room_id: int):
        ...
        self.gamespackage = {"MultiworldGG": static_gamespackage.get("MultiworldGG", {})}  # this may be modified by _load
        self.item_name_groups = {"MultiworldGG": static_item_name_groups.get("MultiworldGG", {})}
        self.location_name_groups = {"MultiworldGG": static_location_name_groups.get("MultiworldGG", {})}
