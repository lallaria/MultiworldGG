...
class Hats:
    ...
    abigails_bow = hat("Abigail's Bow", HatDifficulty.difficult_or_rng)
    arcane_hat = hat("Arcane Hat", HatDifficulty.near_perfection)
    ...
    blue_cowboy_hat = hat("Blue Cowboy Hat", HatDifficulty.difficult_or_rng)
    ...
    cowboy = hat("Cowboy Hat", HatDifficulty.near_perfection)
    ...
    dark_cowboy_hat = hat("Dark Cowboy Hat", HatDifficulty.difficult_or_rng)
    ...
    deluxe_pirate_hat = hat("Deluxe Pirate Hat", HatDifficulty.difficult_or_rng_island)
    ...
    green_turban = hat("Green Turban", HatDifficulty.medium)
    hair_bone = hat("Hair Bone", HatDifficulty.tailoring)
    hard_hat = hat("Hard Hat", HatDifficulty.difficult_or_rng)
    ...
    junimo_hat = hat("Junimo Hat", HatDifficulty.post_perfection)
    knights_helmet = hat("Knight's Helmet", HatDifficulty.near_perfection)
    laurel_wreath_crown = hat("Laurel Wreath Crown", HatDifficulty.difficult_or_rng)
    leprechaun_hat = hat("Leprechaun Hat", HatDifficulty.easy)
    ...
    magic_cowboy_hat = hat("Magic Cowboy Hat", HatDifficulty.difficult_or_rng)
    magic_turban = hat("Magic Turban", HatDifficulty.difficult_or_rng)
    mouse_ears = hat("Mouse Ears", HatDifficulty.easy)
    mr_qis_hat = hat("Mr. Qi's Hat", HatDifficulty.medium_island)
    mummy_mask = hat("Mummy Mask", HatDifficulty.easy)
    mushroom_cap = hat("Mushroom Cap", HatDifficulty.difficult_or_rng)
    mystery_hat = hat("Mystery Hat", HatDifficulty.medium)
    official_cap = hat("Official Cap", HatDifficulty.medium)
    pageboy_cap = hat("Pageboy Cap", HatDifficulty.difficult_or_rng_island)
    panda_hat = hat("Panda Hat", HatDifficulty.impossible)
    paper_hat = hat("Paper Hat", HatDifficulty.easy_island)
    ...
    pink_bow = hat("Pink Bow", HatDifficulty.easy_island)
    ...
    raccoon_hat = hat("Raccoon Hat", HatDifficulty.medium)
    radioactive_goggles = hat("Radioactive Goggles", HatDifficulty.tailoring_island)
    red_cowboy_hat = hat("Red Cowboy Hat", HatDifficulty.difficult_or_rng)
    red_fez = hat("Red Fez", HatDifficulty.medium)
    sailors_cap = hat("Sailor's Cap", HatDifficulty.easy)
    santa_hat = hat("Santa Hat", HatDifficulty.medium)
    skeleton_mask = hat("Skeleton Mask", HatDifficulty.medium)
