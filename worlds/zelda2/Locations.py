...
def get_locations(world: "Zelda2World") -> List[LocationData]:
    ...
    location_table: List[LocationData] = [
        ...
        LocationData("Maze Palace", "Maze Palace: Nook Item", 0x3C),
        LocationData("Maze Palace", "Maze Palace: Sealed Item", 0x3D),
        LocationData("Maze Palace", "Maze Palace: Block Mountain Left", 0x3E),
        LocationData("Maze Palace", "Maze Palace: Block Mountain Right", 0x3F),
        LocationData("Maze Palace", "Maze Palace: West Hall of Fire", 0x40),
        LocationData("Maze Palace", "Maze Palace: East Hall of Fire", 0x41),
        LocationData("Maze Palace", "Maze Palace: Basement Hall of Fire", 0x42),
        LocationData("Maze Palace", "Maze Palace: Block Mountain Basement", 0x43),
        LocationData("Maze Palace", "Maze Palace: Pillar Item", 0x44),
        LocationData("Maze Palace", "Maze Palace: Pedestal Item", 0x45),
        LocationData("Maze Palace", "Maze Palace: Rebonack Drop", 0x46),

        LocationData("Palace on the Sea", "Palace on the Sea: Ledge Item", 0x47),
        LocationData("Palace on the Sea", "Palace on the Sea: Crumbling Bridge", 0x48),
        LocationData("Palace on the Sea", "Palace on the Sea: Falling Blocks", 0x49),
        LocationData("Palace on the Sea", "Palace on the Sea: Above Elevator", 0x4A),
        LocationData("Palace on the Sea", "Palace on the Sea: Block Alcove", 0x4B),
        LocationData("Palace on the Sea", "Palace on the Sea: Knuckle Alcove", 0x4C),
        LocationData("Palace on the Sea", "Palace on the Sea: Pedestal Item", 0x4D),
        LocationData("Palace on the Sea", "Palace on the Sea: Skeleton Key", 0x4E),
        LocationData("Palace on the Sea", "Palace on the Sea: West Wing", 0x4F),
        LocationData("Palace on the Sea", "Palace on the Sea: Block Line", 0x50),
        LocationData("Palace on the Sea", "Palace on the Sea: West Knuckle Alcove", 0x51),
        LocationData("Palace on the Sea", "Palace on the Sea: Gooma Drop", 0x52),

        LocationData("Southeastern Hyrule", "Southeastern Swamp", 0x53),
        LocationData("Southeastern Hyrule", "Southeastern Swamp Cave", 0x54),
        LocationData("Southeastern Hyrule", "Southeastern Coast Item", 0x55),
        LocationData("Southeastern Hyrule", "Southeastern Forest Item", 0x56),
        LocationData("Southeastern Hyrule", "Death Valley Entrance", 0x57),
        LocationData("Southeastern Hyrule", "Death Valley Midway Item", 0x58),
        LocationData("Southeastern Hyrule", "Sage of Kasuto", 0x59),
        LocationData("Southeastern Hyrule", "Sage of New Kasuto", 0x5A),
        LocationData("Southeastern Hyrule", "New Kasuto Shrine", 0x5B),
        LocationData("Southeastern Hyrule", "New Kasuto House", 0x5C),

        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: 1F Block Mountain", 0x5D),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: 1F Enclosed Item", 0x5E),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Middle Pit", 0x5F),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Bottom Pit", 0x60),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Block Stairs", 0x61),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Pit of Sadness", 0x62),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Return of Helmethead", 0x63),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Pedestal Item", 0x64),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Helmethead III: The Revengening", 0x65),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Basement Block Mountain", 0x66),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Pit Hall", 0x67),
        LocationData("Three-Eye Rock Palace", "Three-Eye Rock Palace: Barba Drop", 0x68),
