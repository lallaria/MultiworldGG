...
def get_locations(world: "Zelda2World") -> List[LocationData]:
    ...
    location_table: List[LocationData] = [
        ...
        LocationData("Maze Palace", "Maze Palace: Rebonack Drop", 0x47),
...
static_locations = {
    ...
    "Parapa Palace - West Hall Key": 0x07,
