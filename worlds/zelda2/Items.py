...
item_table: Dict[str, ItemData] = {
    ...
    "Fairy Spell": ItemData("Spells", 0x13, ItemClassification.progression),
    "Fire Spell": ItemData("Spells", 0x14, ItemClassification.filler),
    "Reflect Spell": ItemData("Spells", 0x15, ItemClassification.progression),
