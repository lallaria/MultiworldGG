...
## Add the Paper Mario AP World to your MultiworldGG install
You can double click .apworld files to add apworlds to your MultiworldGG installation.

## Creating a YAML file

### Option A: Generate a template YAML using MultiworldGG and edit it.
Want the typical MultiworldGG experience? Run MultiworldGGLauncher.exe (found in the base MultiworldGG folder) and click 
