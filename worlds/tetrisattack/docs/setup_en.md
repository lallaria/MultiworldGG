# Tetris Attack Setup Guide

## Required Software

- A legally obtained copy of Tetris Attack, NTSC-U version.
...
them. Player options page: [Tetris Attack Player Options Page](/games/Tetris%20Attack/player-options)
...
1. Navigate to the Player Options page, configure your options, and click the "Generate Game" button.
    - Player Options page: [Tetris Attack Player Options Page](/games/Tetris%20Attack/player-options)
...
files. Your patch file should have a `.aptatk` extension.
