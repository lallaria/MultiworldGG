...
class FF4FEWebWorld(WebWorld):
    ...
    setup_en = Tutorial(
        ...
        "A guide to setting up the Final Fantasy IV: Free Enterprise randomizer connected to an MultiworldGG world.",
        "English",
        "setup_en.md",
        "setup/en",
        ["Rosalie"]
...
class FF4FEWorld(World):
    ...
    def pre_fill(self) -> None:
        ...
        fast_fill(self.multiworld, itempool, location_set)
