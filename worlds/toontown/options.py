...
class TreasuresPerLocation(Range):
    """
    The amount of MultiworldGG treasures that'll have items in each location
    """
...
class DeathLinkOption(Toggle):
    """
    Enable to turn on the "DeathLink" mechanic in MultiworldGG.
    """
...
class RingLinkOption(Toggle):
    """
    Enable to turn on the "RingLink" mechanic in MultiworldGG.
    """
...
toontown_option_groups: list[OptionGroup] = [
    OptionGroup("MultiworldGG Settings", [
